/*TO-DO
 * Put ESP32 inside
 * Check everything works (screen, Calibrate)
 * Make S-Bus work
 * Soft Power
 * Add buttons for channel change
 * Make calibration easier (Menu-> Calibrate -> press once, calibrate, press to stop calibration)
 * if temp > maxtemp then turn on fan
 * haptic sensor
 */

const char* ssid = "Corniche";
const char* password = "Corniche74";
...
#define pinmenuright 32
#define pinmenuleft 33
#define pinmenuup 25
#define pinmenudown 26
#define pinmenuok 27
#define inputvoltage A7 //GPIO35 ADC1CH7
...
//--------------------------------------------------MENU--------------------------------------------------
  pinMode(pinmenuright, INPUT_PULLUP);
  pinMode(pinmenuleft, INPUT_PULLUP);
  pinMode(pinmenuup, INPUT_PULLUP);
  pinMode(pinmenudown, INPUT_PULLUP);
  pinMode(pinmenuok, INPUT_PULLUP);
...
//--------------------------------------------------MENU--------------------------------------------------
int readingmenuok = digitalRead(pinmenuok);
int readingmenuright = digitalRead(pinmenuright);
int readingmenuleft = digitalRead(pinmenuleft);
int readingmenuup = digitalRead(pinmenuup);
int readingmenudown = digitalRead(pinmenudown);
