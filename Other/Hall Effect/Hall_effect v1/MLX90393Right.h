...
#ifndef MLX90393Right_H_INCLUDED
#define MLX90393Right_H_INCLUDED
...
public:
  ...
  uint8_t readRegister(uint8_t address, uint16_t& datar);
  uint8_t writeRegister(uint8_t address, uint16_t datar);
  uint8_t reset();
...
private:
  ...
  void cache_set(uint8_t address, uint16_t datar);
  uint8_t cache_fill();
...
#endif // #ifndef MLX90393Right_H_INCLUDED
